...
class RTPPriorityQueueTest {
    ...
    void testPriorityResolutionFromConfig() throws Exception {
        ...
        Player regular = createMockPlayer(UUID.randomUUID(), "Player1", java.util.Collections.emptySet());
        Player vip = createMockPlayer(UUID.randomUUID(), "PlayerVIP", java.util.Collections.singleton("ultimatedonutsmp.rtp.priority.vip"));
        Player vipPlusPlus = createMockPlayer(UUID.randomUUID(), "PlayerVIPPlusPlus", java.util.Collections.singleton("ultimatedonutsmp.rtp.priority.vip++"));
        Player customNumeric = createMockPlayer(UUID.randomUUID(), "PlayerNumeric", java.util.Collections.singleton("ultimatedonutsmp.rtp.priority.50"));
    ...
    void testPriorityQueueOrderingAndPosition() throws Exception {
        ...
        Player dummy = createMockPlayer(UUID.randomUUID(), "Dummy", java.util.Collections.emptySet());
        ...
        Player regular = createMockPlayer(regularId, "Regular", java.util.Collections.emptySet());
        Player vip = createMockPlayer(vipId, "VIP", java.util.Collections.singleton("ultimatedonutsmp.rtp.priority.vip"));
        Player vipPlusPlus = createMockPlayer(vipPlusPlusId, "VIP++", java.util.Collections.singleton("ultimatedonutsmp.rtp.priority.vip++"));
    ...
    void testPriorityQueueDisabled() throws Exception {
        ...
        Player player = createMockPlayer(UUID.randomUUID(), "Player1", java.util.Collections.singleton("ultimatedonutsmp.rtp.priority.vip++"));
