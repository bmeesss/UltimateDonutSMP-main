...
public final class Binding {
    ...
    public Binding(ValueApplier applier, ValueCopier copier) {
        this.applier = applier;
        this.copier = copier;
    }

    public ValueApplier applier() { return applier; }
    public ValueCopier copier() { return copier; }

    @Override public String toString() {
        return "Binding[applier=+applier, copier=+copier]";
    }
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (o == null || getClass() != o.getClass()) return false;
        Binding that = (Binding) o;
        return java.util.Objects.equals(applier, that.applier) && java.util.Objects.equals(copier, that.copier);
    }
    @Override public int hashCode() {
        return java.util.Objects.hash(applier, copier);
    }
}
}
