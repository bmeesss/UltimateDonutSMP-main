...
public final class DuelMapSelection {
    private final Type type;
    private final String value;

    public DuelMapSelection(Type type, String value) {
        this.type = type;
        this.value = value;
    }
    ...
    public String serialize() {
        return switch (type) {        case STATIC_ARENA: "arena:" + value; break;        case RANDOM_STATIC: "random_static"; break;        case BIOME: "biome:" + value; break;        case RANDOM_BIOME: "random_biome"; break;
        };
    }
    ...
    @Override public String toString() {
        return "DuelMapSelection[type=+type, value=+value]";
    }
}
