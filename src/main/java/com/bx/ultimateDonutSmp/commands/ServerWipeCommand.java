...
public class ServerWipeCommand implements CommandExecutor, TabCompleter {
    ...
    private static final List<String> SUBCOMMANDS = new java.util.ArrayList<>(java.util.Arrays.asList("preview",  "prepare",  "confirm",  "cancel",  "status"));
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        switch (sub) {
            case "preview":
                ...
                break;
            case "status":
                send(sender, "&7Server wipe: &f" + plugin.getServerWipeManager().describeStatus());
                break;
            case "prepare": {
