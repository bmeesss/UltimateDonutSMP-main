...
public class CrateCommand implements CommandExecutor, TabCompleter {
    ...
    private static final List<String> PLAYER_SUBCOMMANDS = new java.util.ArrayList<>(java.util.Arrays.asList("keys",  "open"));
    private static final List<String> ADMIN_SUBCOMMANDS = new java.util.ArrayList<>(java.util.Arrays.asList(
            "create",  "delete",  "type",  "key",  "take",  "set",  "add",  "edit",  "remove",  "bind",  "unbind",  "listbound",  "info"
    ));
    private static final List<String> OPEN_TYPE_COMPLETIONS = new java.util.ArrayList<>(java.util.Arrays.asList("choose_one",  "choose-one",  "gacha"));
    private static final List<String> AMOUNT_COMPLETIONS = new java.util.ArrayList<>(java.util.Arrays.asList("1",  "5",  "10",  "25",  "64"));
    private static final List<String> SLOT_COMPLETIONS = new java.util.ArrayList<>(java.util.Arrays.asList("1",  "2",  "3",  "4",  "5",  "6",  "7",  "8",  "9"));
    ...
    private boolean handleRewardMutation(CommandSender sender, String label, String[] args, RewardMutationMode mode) {
        ...
        if (mode == RewardMutationMode.ADD && args.length >= 4) {
            ...
            if (verb.equals("command")) {
                ...
                result = plugin.getCrateManager().addCommandReward(crate.id(), slot, java.util.Collections.singletonList(consoleCommand));
