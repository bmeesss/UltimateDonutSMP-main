...
public class HomeMenu extends BaseMenu {
    ...
    private void buildPageButtons(int totalPages) {
        if (page > 0) {
            set(PREV_PAGE_SLOT, ItemUtils.createItem(
                    Material.ARROW,
                    "&fPrevious page",
                    new java.util.ArrayList<>(java.util.Arrays.asList("&7Go to page &f" + page,  "&7Current page: &f" + (page + 1) + "/" + totalPages))
            ));
        ...
        if (page < totalPages - 1) {
            set(NEXT_PAGE_SLOT, ItemUtils.createItem(
                    Material.ARROW,
                    "&fNext page",
                    new java.util.ArrayList<>(java.util.Arrays.asList("&7Go to page &f" + (page + 2),  "&7Current page: &f" + (page + 1) + "/" + totalPages))
            ));
    ...
    private List<String> defaultTeamTeleportLore(Team team, String state) {
        if ("NO_TEAM".equals(state)) return java.util.Collections.singletonList("&7You are not in a team.");
        if ("NO_HOME".equals(state)) return java.util.Collections.singletonList("&7Click to create your team home.");
        return new java.util.ArrayList<>(java.util.Arrays.asList("&7World: &f{world}",  "&aLeft-click to teleport"));
    }

    private List<String> defaultTeamActionLore(Team team, String state) {
        if ("NO_TEAM".equals(state)) return java.util.Collections.singletonList("&7You are not in a team.");
        if ("NO_HOME".equals(state)) return java.util.Collections.singletonList("&7Left-click to save your team home.");
        return new java.util.ArrayList<>(java.util.Arrays.asList("&bLeft-click to update the team home",  "&cRight-click to delete"));
    }
