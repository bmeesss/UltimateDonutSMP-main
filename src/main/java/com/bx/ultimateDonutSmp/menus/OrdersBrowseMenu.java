    ...
    public void build(Player player) {
        ...
        if (page > 1) {
            set(prevSlot, OrdersMenuSupport.button(
                    ...
                    Material.ARROW, "&aPrevious", java.util.Collections.singletonList("&fClick to open page {page}"),
        ...
        if (hasNextPage(orders.size(), itemsPerPage)) {
            set(nextSlot, OrdersMenuSupport.button(
                    ...
                    Material.ARROW, "&aNext", java.util.Collections.singletonList("&fClick to open page {page}"),
                    "{page}", String.valueOf(page + 1)
            ));
        }
        ...
        set(refreshSlot, OrdersMenuSupport.button(
                ...
                Material.MAP, "&aRefresh", java.util.Collections.singletonList("&fClick to refresh")
        ));
        ...
        set(myOrdersSlot, OrdersMenuSupport.button(
                ...
                Material.CHEST, "&aYour orders", java.util.Collections.singletonList("&fClick to manage your orders")
        ));
        if (manager.isClaimsEnabled()) {
            set(collectSlot, OrdersMenuSupport.button(
                    ...
                    Material.DROPPER, "&aCollect", java.util.Collections.singletonList("&fCollect delivered items and refunds")
            ));
        }
        ...
        if (orders.isEmpty()) {
            set(22, ItemUtils.createItem(
                    ...
                    OrdersMenuSupport.list(plugin, "ORDERS.GUI.MAIN.EMPTY.LORE", java.util.Collections.singletonList("&7No orders match this view."))
            ));
        }
    }
