...
public class FriendDetailMenu extends BaseMenu {
    ...
    public void build(Player player) {
        ...
        // Head (Slot 10)
        List<String> headLore = new java.util.ArrayList<>(java.util.Arrays.asList(
                "&7Status: " + status, 
                "&7Relationship: " + rel
        ));
        ...
        if (isFollowing) {
            actionItem = ItemUtils.createItem(
                    ...
                    "&cRemove friend",
                    java.util.Collections.singletonList("&7Click to remove friend")
            );
        } else if (isFollower) {
            actionItem = ItemUtils.createItem(
                    Material.INK_SACK,
        ...
        set(18, ItemUtils.createItem(
                Material.ARROW,
                "&cBack",
                java.util.Collections.singletonList("&7Return to friends list")
        ));
    }
    ...
    public void handleClick(int slot, Player player, ClickType clickType) {
        ...
        if (slot == 13 || slot == 14 || slot == 15 || slot == 16 || slot == 22 || slot == 23) {
            ...
            switch (slot) {        case 13: transactions = !transactions; break;        case 14: messages = !messages; break;        case 15: payments = !payments; break;        case 16: activity = !activity; break;        case 22: tpaAuto = !tpaAuto; break;        case 23: teleport = !teleport; break;
            }
