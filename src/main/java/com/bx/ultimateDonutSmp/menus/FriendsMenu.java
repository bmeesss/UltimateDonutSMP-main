...
public final class PlayerEntry {
    ...
    public PlayerEntry(UUID uuid, String name, boolean following, boolean follower) {
        this.uuid = uuid;
        this.name = name;
    ...
    public boolean follower() { return follower; }
    ...
    @Override public String toString() {
        return "PlayerEntry[uuid=+uuid, name=+name, following=+following, follower=+follower]";
    }
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (o == null || getClass() != o.getClass()) return false;
        PlayerEntry that = (PlayerEntry) o;
        return java.util.Objects.equals(uuid, that.uuid) && java.util.Objects.equals(name, that.name) && java.util.Objects.equals(following, that.following) && java.util.Objects.equals(follower, that.follower);
    }
    @Override public int hashCode() {
        return java.util.Objects.hash(uuid, name, following, follower);
    }
}
    ...
    public void build(Player player) {
        ...
        for (PlayerEntry pe : entryMap.values()) {
            // Apply filter type
            switch (filterType) {        case FRIENDS: {
        ...
        if (currentPage > 0) {
            set(45, ItemUtils.createItem(
                    Material.ARROW,
                    "&aPrevious page",
                    java.util.Collections.singletonList("&7Go to page " + currentPage)
            ));
        }
        ...
        if (currentPage < totalPages - 1) {
            set(53, ItemUtils.createItem(
                    Material.ARROW,
                    "&aNext page",
                    java.util.Collections.singletonList("&7Go to page " + (currentPage + 2))
            ));
        }
    }
    ...
    private void promptSearch(Player player) {
        SignInputUtil.open(
                plugin,
                player,
                new java.util.ArrayList<>(java.util.Arrays.asList("",  "↑↑↑↑↑↑↑↑↑↑↑↑↑↑",  "Search",  "")),
                0,
                text -> {
