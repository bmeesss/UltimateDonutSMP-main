...
public class HomeActionMenu extends BaseMenu {
    ...
    public void build(Player player) {
        ...
        set(11, ItemUtils.createItem(
                ...
                "&aTeleport to Home",
                java.util.Collections.singletonList("&7Click to teleport to &f" + home.getName())
        ));
        slotActions.put(11, () -> {
        ...
        set(13, ItemUtils.createItem(
                Material.NAME_TAG,
                "&eRename Home",
                java.util.Collections.singletonList("&7Click to rename &f" + home.getName())
        ));
        ...
        set(26, ItemUtils.createItem(
                Material.BARRIER,
                "&cBack",
                java.util.Collections.singletonList("&7Go back to homes menu")
        ));
