...
public class BillfordMenu extends BaseMenu {
    ...
    public void build(Player player) {
        ...
        if (currentTrade == null) {
            set(inventory.getSize() / 2, ItemUtils.createItem(
                    ...
                    java.util.Collections.singletonList("&7Add entries inside &fbillford.yml &7to enable the system.")
            ));
            return;
        }
    ...
    private void fail(Player player, String messagePath, String fallbackMessage) {
        ...
        if (message.startsWith("&cMessage not found") || message.startsWith("&cᴍᴇѕѕᴀɢᴇ ɴᴏᴛ ꜰᴏᴜɴᴅ")) {
