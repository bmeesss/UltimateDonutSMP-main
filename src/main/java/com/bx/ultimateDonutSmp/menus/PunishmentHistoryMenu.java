...
public class PunishmentHistoryMenu extends BaseMenu {
    ...
    private void buildEmptyState() {
        ...
        if (lore.isEmpty()) {
            lore = java.util.Collections.singletonList("&7This player has no punishment records.");
        }
    ...
    private void buildBackButton() {
        ...
        List<String> fallbackLore = returnToProfileViewer
                ? java.util.Collections.singletonList("&7Return to the profile viewer.")
    ...
    private void buildRefreshButton() {
        set(REFRESH_SLOT, ItemUtils.createItem(
                ...
                replaceMenuPlaceholders(defaultIfEmpty(
                        ...
                        java.util.Collections.singletonList("&7Reload this player's punishment history.")
                ))
        ));
    }
