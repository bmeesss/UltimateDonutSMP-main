...
public class PurchaseShopMenu extends BaseMenu {
    ...
    private void buildCancelButton() {
        set(getCancelSlot(), ItemUtils.createItem(
                ItemUtils.parseMaterial(getMenus().getString("PURCHASE-SHOP-MENU.BUTTONS.CANCEL.MATERIAL", "STAINED_GLASS_PANE"), Material.STAINED_GLASS_PANE),
    ...
    private void buildConfirmButton() {
        set(getConfirmSlot(), ItemUtils.createItem(
                ItemUtils.parseMaterial(getMenus().getString("PURCHASE-SHOP-MENU.BUTTONS.CONFIRM.MATERIAL", "STAINED_GLASS_PANE"), Material.STAINED_GLASS_PANE),
    ...
    private void buildQuantityButtons() {
        Material addMaterial = ItemUtils.parseMaterial(
                getMenus().getString("PURCHASE-SHOP-MENU.BUTTONS.QUANTITY_ADJUST.ADD.MATERIAL", "STAINED_GLASS_PANE"), Material.STAINED_GLASS_PANE);
        Material removeMaterial = ItemUtils.parseMaterial(
                getMenus().getString("PURCHASE-SHOP-MENU.BUTTONS.QUANTITY_ADJUST.REMOVE.MATERIAL", "STAINED_GLASS_PANE"), Material.STAINED_GLASS_PANE);
