    ...
    public EnchantSelectMenu(UltimateDonutSmp plugin, Player player, Material material) {
        ...
        if (draft != null && draft.requestedItem() != null) {
            ...
            if (draftItem.getType() == Material.ENCHANTED_BOOK) {
                if (draftItem.getItemMeta() instanceof org.bukkit.inventory.meta.EnchantmentStorageMeta) {
                    org.bukkit.inventory.meta.EnchantmentStorageMeta esm = (org.bukkit.inventory.meta.EnchantmentStorageMeta) draftItem.getItemMeta();
