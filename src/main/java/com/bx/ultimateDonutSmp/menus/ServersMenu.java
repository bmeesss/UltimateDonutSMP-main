...
public final class MenuEntry {
    ...
    public MenuEntry(String serverId, int slot) {
    ...
    @Override public String toString() {
        return "MenuEntry[serverId=+serverId, slot=+slot]";
    }
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (o == null || getClass() != o.getClass()) return false;
        MenuEntry that = (MenuEntry) o;
        return java.util.Objects.equals(serverId, that.serverId) && java.util.Objects.equals(slot, that.slot);
    }
    @Override public int hashCode() {
        return java.util.Objects.hash(serverId, slot);
    }
}
}
