...
public class SpawnerStorageMenu extends BaseMenu {
    ...
    public void build(Player player) {
        ...
        if (backLore.isEmpty()) backLore = java.util.Collections.singletonList("&7Return to spawner menu.");
        ...
        if (filterLore.isEmpty()) filterLore = new java.util.ArrayList<>(java.util.Arrays.asList("&7Manage item drops filter.",  "",  "&eClick to open filter settings"));
        ...
        if (collectLore.isEmpty()) collectLore = java.util.Collections.singletonList("&e• &fCollect all loot from storage into inventory");
        ...
        if (dropLore.isEmpty()) dropLore = java.util.Collections.singletonList("&fClick to drop all loot on the page");
        ...
        if (sellLore.isEmpty()) sellLore = java.util.Collections.singletonList("&fClick to sell all mob drops!");
