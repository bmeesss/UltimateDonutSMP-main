    ...
    private static ButtonAction resolveAction(UltimateDonutSmp plugin, String key, ConfigurationSection buttonSection) {
        ...
        switch (key.toUpperCase(Locale.ROOT)) {
            ...
            case "LEADERBOARDS":
                ...
                break;
            case "SHARDS":
                action = ButtonAction.command("afk");
                break;
            case "SETTINGS":
                action = ButtonAction.command("settings");
                break;
            case "RTP":
                action = ButtonAction.command("rtp");
                break;
            case "SPAWN":
                action = ButtonAction.command("spawn");
                break;
            case "HOME":
            case "HOMES":
                action = ButtonAction.command("home");
                break;
            case "TEAM":
            case "TEAMS":
                action = ButtonAction.command("team");
                break;
            case "SHOP":
                action = ButtonAction.command("shop");
                break;
            case "SELL":
                action = ButtonAction.command("sell");
                break;
            case "TPA":
                action = ButtonAction.command("tpa");
                break;
            case "STATS":
            ...
            case "SOCIAL":
                ...
                break;
            case "MEDIA":
                action = ButtonAction.command("media");
                break;
            case "SERVER":
                action = ButtonAction.info(new java.util.ArrayList<>(java.util.Arrays.asList(
                        "&7Build your base,  gear up,  and use &f/spawn &7or &f/rtp &7to begin exploring."
                )));
                break;
            case "ECONOMY":
                action = ButtonAction.info(java.util.Collections.singletonList(
                ...
                break;
            default:
                action = ButtonAction.info(java.util.Collections.singletonList("&7This button is informational only."));
                break;
        }
        return action;
    }
...
public final class PageDefinition {
    ...
    public PageDefinition(String key, String title, int size, List<ButtonDefinition> buttons) {
        this.key = key;
        this.title = title;
        this.size = size;
    ...
    @Override public String toString() {
        return "PageDefinition[key=+key, title=+title, size=+size, buttons=+buttons]";
    }
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (o == null || getClass() != o.getClass()) return false;
        PageDefinition that = (PageDefinition) o;
        return java.util.Objects.equals(key, that.key) && java.util.Objects.equals(title, that.title) && java.util.Objects.equals(size, that.size) && java.util.Objects.equals(buttons, that.buttons);
    }
    @Override public int hashCode() {
        return java.util.Objects.hash(key, title, size, buttons);
    }
}
...
public final class ButtonAction {
    ...
    public ButtonAction(ActionType type, String command, List<String> messages) {
        this.type = type;
    ...
    public List<String> messages() { return messages; }
        ...
        private static ButtonAction command(String command) {
            return new ButtonAction(ActionType.COMMAND, command, java.util.Collections.emptyList());
        }
    ...
    @Override public String toString() {
        return "ButtonAction[type=+type, command=+command, messages=+messages]";
    }
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (o == null || getClass() != o.getClass()) return false;
        ButtonAction that = (ButtonAction) o;
        return java.util.Objects.equals(type, that.type) && java.util.Objects.equals(command, that.command) && java.util.Objects.equals(messages, that.messages);
    }
    @Override public int hashCode() {
        return java.util.Objects.hash(type, command, messages);
    }
}
}
