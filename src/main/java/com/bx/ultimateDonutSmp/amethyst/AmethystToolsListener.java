...
public class AmethystToolsListener implements Listener {
    ...
    public void onBlockBreak(BlockBreakEvent event) {
        ...
        switch (type) {        case DRILL: handleDrill(event, player, item); break;        case SHOVEL: handleShovel(event, player, item); break;        case CHOPPER: handleChopper(event, player, item); break;        default: {
