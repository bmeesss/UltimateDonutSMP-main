...
public class DuelWorldManager {
    ...
    private static final Set<String> DEFAULT_EXCLUDED_BIOMES = new java.util.LinkedHashSet<>(java.util.Arrays.asList(
            "minecraft:the_end", 
...
public final class GeneratedArena {
    ...
    public GeneratedArena(DuelArena arena, DuelMapSelection selection, String biomeKey, String worldName, TerrainMode terrainMode) {
        this.arena = arena;
    ...
    @Override public String toString() {
        return "GeneratedArena[arena=+arena, selection=+selection, biomeKey=+biomeKey, worldName=+worldName, terrainMode=+terrainMode]";
    }
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (o == null || getClass() != o.getClass()) return false;
        GeneratedArena that = (GeneratedArena) o;
        return java.util.Objects.equals(arena, that.arena) && java.util.Objects.equals(selection, that.selection) && java.util.Objects.equals(biomeKey, that.biomeKey) && java.util.Objects.equals(worldName, that.worldName) && java.util.Objects.equals(terrainMode, that.terrainMode);
    }
    @Override public int hashCode() {
        return java.util.Objects.hash(arena, selection, biomeKey, worldName, terrainMode);
    }
}
...
public final class ChunkCoord {
    ...
    @Override public boolean equals(Object o) {
        ...
        return java.util.Objects.equals(x, that.x) && java.util.Objects.equals(z, that.z);
    }
    @Override public int hashCode() {
    ...
    private static final class SingleBiomeProvider extends BiomeProvider {
        ...
        public List<Biome> getBiomes(WorldInfo worldInfo) {
            return java.util.Collections.singletonList(biome);
        }
    }
