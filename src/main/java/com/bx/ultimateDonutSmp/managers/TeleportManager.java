...
public final class PlayerDistanceState {
    private final Integer viewDistance;
    private final Integer simulationDistance;
    private final Integer noTickViewDistance;
    private final Integer sendViewDistance;

    public PlayerDistanceState(Integer viewDistance, Integer simulationDistance, Integer noTickViewDistance, Integer sendViewDistance) {
    ...
    public Integer viewDistance() { return viewDistance; }
    public Integer simulationDistance() { return simulationDistance; }
    public Integer noTickViewDistance() { return noTickViewDistance; }
    public Integer sendViewDistance() { return sendViewDistance; }

    @Override public String toString() {
        return "PlayerDistanceState[viewDistance=+viewDistance, simulationDistance=+simulationDistance, noTickViewDistance=+noTickViewDistance, sendViewDistance=+sendViewDistance]";
    }
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (o == null || getClass() != o.getClass()) return false;
        PlayerDistanceState that = (PlayerDistanceState) o;
        return java.util.Objects.equals(viewDistance, that.viewDistance) && java.util.Objects.equals(simulationDistance, that.simulationDistance) && java.util.Objects.equals(noTickViewDistance, that.noTickViewDistance) && java.util.Objects.equals(sendViewDistance, that.sendViewDistance);
    }
    @Override public int hashCode() {
        return java.util.Objects.hash(viewDistance, simulationDistance, noTickViewDistance, sendViewDistance);
    }
}
