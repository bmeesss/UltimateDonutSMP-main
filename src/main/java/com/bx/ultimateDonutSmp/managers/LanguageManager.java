...
public class LanguageManager {
    ...
    private void rebuildBuiltInTranslations() {
        ...
        for (String path : english.getKeys(true)) {
            ...
            if (source instanceof String && translated instanceof String) {
            ...
            } else if (source instanceof List<?> && translated instanceof List<?>) {
                ...
                for (int index = 0; index < size; index++) {
                    ...
                    if (sourceLine instanceof String && translatedLine instanceof String) {
