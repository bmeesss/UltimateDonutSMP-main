...
public class OptimizationManager {
    ...
    public static final class TaskThrottle {
    private final boolean enabled;
    private final long warnMinIntervalMillis;
    private final long criticalMinIntervalMillis;

    public TaskThrottle(boolean enabled, long warnMinIntervalMillis, long criticalMinIntervalMillis) {
        this.enabled = enabled;
        this.warnMinIntervalMillis = warnMinIntervalMillis;
        this.criticalMinIntervalMillis = criticalMinIntervalMillis;
    }

    public boolean enabled() { return enabled; }
    public long warnMinIntervalMillis() { return warnMinIntervalMillis; }
    public long criticalMinIntervalMillis() { return criticalMinIntervalMillis; }
    ...
    @Override public String toString() {
        return "TaskThrottle[enabled=" + enabled + ", warnMinIntervalMillis=" + warnMinIntervalMillis + ", criticalMinIntervalMillis=" + criticalMinIntervalMillis + "]";
    }
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (o == null || getClass() != o.getClass()) return false;
        TaskThrottle that = (TaskThrottle) o;
        return java.util.Objects.equals(enabled, that.enabled) && java.util.Objects.equals(warnMinIntervalMillis, that.warnMinIntervalMillis) && java.util.Objects.equals(criticalMinIntervalMillis, that.criticalMinIntervalMillis);
    }
    @Override public int hashCode() {
        return java.util.Objects.hash(enabled, warnMinIntervalMillis, criticalMinIntervalMillis);
    }
}
}
