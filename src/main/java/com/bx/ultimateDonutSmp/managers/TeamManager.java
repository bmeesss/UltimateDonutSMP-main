...
public class TeamManager {
    ...
    public List<String> getPendingInvites(UUID uuid) {
        ...
        return invites == null ? Collections.emptyList() : new java.util.ArrayList<>(invites);
    }
...
public final class PendingTeamSearch {
    private final int page;
    private final TeamMenu.SortMode sortMode;

    public PendingTeamSearch(int page, TeamMenu.SortMode sortMode) {
        this.page = page;
        this.sortMode = sortMode;
    }

    public int page() { return page; }
    public TeamMenu.SortMode sortMode() { return sortMode; }

    @Override public String toString() {
        return "PendingTeamSearch[page=+page, sortMode=+sortMode]";
    }
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (o == null || getClass() != o.getClass()) return false;
        PendingTeamSearch that = (PendingTeamSearch) o;
        return java.util.Objects.equals(page, that.page) && java.util.Objects.equals(sortMode, that.sortMode);
    }
    @Override public int hashCode() {
        return java.util.Objects.hash(page, sortMode);
    }
}
}
