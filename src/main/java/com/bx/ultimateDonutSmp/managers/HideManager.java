...
public final class Result {
    ...
    private final HideState state;
    private final long remainingSeconds;

    public Result(ResultType type, HideState state, long remainingSeconds) {
        this.type = type;
        this.state = state;
    ...
    public HideState state() { return state; }
    ...
    @Override public String toString() {
        return "Result[type=+type, state=+state, remainingSeconds=+remainingSeconds]";
    }
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (o == null || getClass() != o.getClass()) return false;
        Result that = (Result) o;
        return java.util.Objects.equals(type, that.type) && java.util.Objects.equals(state, that.state) && java.util.Objects.equals(remainingSeconds, that.remainingSeconds);
    }
    @Override public int hashCode() {
        return java.util.Objects.hash(type, state, remainingSeconds);
    }
}

public final class AliasOption {
    private final String key;
    private final String name;
    private final String skinKey;
    private final String skinUsername;

    public AliasOption(String key, String name, String skinKey, String skinUsername) {
        this.key = key;
        this.name = name;
    ...
    @Override public String toString() {
        return "AliasOption[key=+key, name=+name, skinKey=+skinKey, skinUsername=+skinUsername]";
    }
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (o == null || getClass() != o.getClass()) return false;
        AliasOption that = (AliasOption) o;
        return java.util.Objects.equals(key, that.key) && java.util.Objects.equals(name, that.name) && java.util.Objects.equals(skinKey, that.skinKey) && java.util.Objects.equals(skinUsername, that.skinUsername);
    }
    @Override public int hashCode() {
        return java.util.Objects.hash(key, name, skinKey, skinUsername);
    }
}

public final class SkinOption {
    private final String key;
    private final String displayName;
    private final String username;

    public SkinOption(String key, String displayName, String username) {
        this.key = key;
    ...
    @Override public String toString() {
        return "SkinOption[key=+key, displayName=+displayName, username=+username]";
    }
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (o == null || getClass() != o.getClass()) return false;
        SkinOption that = (SkinOption) o;
        return java.util.Objects.equals(key, that.key) && java.util.Objects.equals(displayName, that.displayName) && java.util.Objects.equals(username, that.username);
    }
    @Override public int hashCode() {
        return java.util.Objects.hash(key, displayName, username);
    }
}
    ...
    public HeadTexture(String value, String signature) {
        this.value = value;
    ...
    @Override public String toString() {
        return "HeadTexture[value=+value, signature=+signature]";
    }
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (o == null || getClass() != o.getClass()) return false;
        HeadTexture that = (HeadTexture) o;
        return java.util.Objects.equals(value, that.value) && java.util.Objects.equals(signature, that.signature);
    }
    @Override public int hashCode() {
        return java.util.Objects.hash(value, signature);
    }
}
