...
public class WorthManager {
    ...
    private static final Set<Material> FISH_CATEGORY_OVERRIDES = Enumnew java.util.LinkedHashSet<>(java.util.Arrays.asList(
            Material.COD, 
            Material.COOKED_COD, 
            Material.SALMON, 
    ...
    private static final Set<Material> POTION_CATEGORY_OVERRIDES = Enumnew java.util.LinkedHashSet<>(java.util.Arrays.asList(
            Material.POTION, 
...
public final class WorthCacheKey {
    ...
    public java.util.Map<Enchantment, java.lang.Integer> enchantments() { return enchantments; }
        ...
        public static WorthCacheKey of(ItemStack item) {
            ...
            PotionMeta meta = (PotionMeta) this == o) return true;
        if (o == null || getClass() != o.getClass()) return false;
        WorthBrowserEntry that = (WorthBrowserEntry) o;
        return java.util.Objects.equals(material, that.material) && java.util.Objects.equals(categoryKey, that.categoryKey) && java.util.Objects.equals(unitWorth, that.unitWorth) && java.util.Objects.equals(sourceKey, that.sourceKey);
    }
...
public final class WorthCacheKey {
    ...
    public java.util.Map<Enchantment, java.lang.Integer> enchantments() { return enchantments; }
        ...
        public static WorthCacheKey of(ItemStack item) {
            ...
            EnchantmentStorageMeta meta = (EnchantmentStorageMeta) item.getType() == Material.ENCHANTED_BOOK) {
                if (item.getItemMeta();
    ...
    @Override public String toString() {
        return "WorthCacheKey[material=+material, potionType=+potionType, enchantments=+enchantments]";
    }
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (o == null || getClass() != o.getClass()) return false;
        WorthCacheKey that = (WorthCacheKey) o;
        return java.util.Objects.equals(material, that.material) && java.util.Objects.equals(potionType, that.potionType) && java.util.Objects.equals(enchantments, that.enchantments);
    }
    @Override public int hashCode() {
        return java.util.Objects.hash(material, potionType, enchantments);
    }
}
    ...
    private Pattern buildWorthLorePattern() {
        ...
        List<String> placeholders = new java.util.ArrayList<>(java.util.Arrays.asList(
