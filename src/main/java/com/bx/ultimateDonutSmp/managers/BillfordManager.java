...
public final class BillfordSlot {
    private final int slot;
    private final Material material;
    private final int quantity;

    public BillfordSlot(int slot, Material material, int quantity) {
        this.slot = slot;
    ...
    @Override public String toString() {
        return "BillfordSlot[slot=+slot, material=+material, quantity=+quantity]";
    }
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (o == null || getClass() != o.getClass()) return false;
        BillfordSlot that = (BillfordSlot) o;
        return java.util.Objects.equals(slot, that.slot) && java.util.Objects.equals(material, that.material) && java.util.Objects.equals(quantity, that.quantity);
    }
    @Override public int hashCode() {
        return java.util.Objects.hash(slot, material, quantity);
    }
}

public final class BillfordTrade {
    private final int id;
    private final String displayName;
    private final int tradeLimit;
    private final long shardBonus;
    private final double moneyBonus;
    private final List<BillfordSlot> requiredItems;
    private final Material rewardMaterial;
    private final int rewardQuantity;

    public BillfordTrade(int id, String displayName, int tradeLimit, long shardBonus, double moneyBonus, List<BillfordSlot> requiredItems, Material rewardMaterial, int rewardQuantity) {
        this.id = id;
    ...
    public int tradeLimit() { return tradeLimit; }
    public long shardBonus() { return shardBonus; }
    public double moneyBonus() { return moneyBonus; }
    public List<BillfordSlot> requiredItems() { return requiredItems; }
    public Material rewardMaterial() { return rewardMaterial; }
    ...
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (o == null || getClass() != o.getClass()) return false;
        BillfordTrade that = (BillfordTrade) o;
        return java.util.Objects.equals(id, that.id) && java.util.Objects.equals(displayName, that.displayName) && java.util.Objects.equals(tradeLimit, that.tradeLimit) && java.util.Objects.equals(shardBonus, that.shardBonus) && java.util.Objects.equals(moneyBonus, that.moneyBonus) && java.util.Objects.equals(requiredItems, that.requiredItems) && java.util.Objects.equals(rewardMaterial, that.rewardMaterial) && java.util.Objects.equals(rewardQuantity, that.rewardQuantity);
    }
    @Override public int hashCode() {
        return java.util.Objects.hash(id, displayName, tradeLimit, shardBonus, moneyBonus, requiredItems, rewardMaterial, rewardQuantity);
    }
}
