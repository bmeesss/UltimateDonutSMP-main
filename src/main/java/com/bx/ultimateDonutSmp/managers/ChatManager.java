...
public final class ClickAction {
    ...
    public ClickAction(ClickActionType type, String command) {
        this.type = type;
        this.command = command;
    }

    public ClickActionType type() { return type; }
    public String command() { return command; }

    @Override public String toString() {
        return "ClickAction[type=+type, command=+command]";
    }
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (o == null || getClass() != o.getClass()) return false;
        ClickAction that = (ClickAction) o;
        return java.util.Objects.equals(type, that.type) && java.util.Objects.equals(command, that.command);
    }
    @Override public int hashCode() {
        return java.util.Objects.hash(type, command);
    }
}
...
public final class FilterResult {
    ...
    public FilterResult(boolean allowed, String blockMessage, String normalizedMessage) {
    ...
    public String blockMessage() { return blockMessage; }
    public String normalizedMessage() { return normalizedMessage; }
    ...
    @Override public String toString() {
        return "FilterResult[allowed=+allowed, blockMessage=+blockMessage, normalizedMessage=+normalizedMessage]";
    }
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (o == null || getClass() != o.getClass()) return false;
        FilterResult that = (FilterResult) o;
        return java.util.Objects.equals(allowed, that.allowed) && java.util.Objects.equals(blockMessage, that.blockMessage) && java.util.Objects.equals(normalizedMessage, that.normalizedMessage);
    }
    @Override public int hashCode() {
        return java.util.Objects.hash(allowed, blockMessage, normalizedMessage);
    }
}
...
public final class DelayResult {
    ...
    public DelayResult(boolean allowed, long remainingSeconds) {
        this.allowed = allowed;
    ...
    @Override public String toString() {
        return "DelayResult[allowed=+allowed, remainingSeconds=+remainingSeconds]";
    }
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (o == null || getClass() != o.getClass()) return false;
        DelayResult that = (DelayResult) o;
        return java.util.Objects.equals(allowed, that.allowed) && java.util.Objects.equals(remainingSeconds, that.remainingSeconds);
    }
    @Override public int hashCode() {
        return java.util.Objects.hash(allowed, remainingSeconds);
    }
}
}
