...
public class FreezeManager {
    ...
    public void shutdown() {
        ...
        for (UUID targetUuid : new java.util.ArrayList<>(activeStates.keySet())) {
...
public final class FreezeToggleResult {
    private final boolean active;
    private final FreezeState state;

    public FreezeToggleResult(boolean active, FreezeState state) {
        this.active = active;
        this.state = state;
    }

    public boolean active() { return active; }
    public FreezeState state() { return state; }

    @Override public String toString() {
        return "FreezeToggleResult[active=+active, state=+state]";
    }
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (o == null || getClass() != o.getClass()) return false;
        FreezeToggleResult that = (FreezeToggleResult) o;
        return java.util.Objects.equals(active, that.active) && java.util.Objects.equals(state, that.state);
    }
    @Override public int hashCode() {
        return java.util.Objects.hash(active, state);
    }
}
}
