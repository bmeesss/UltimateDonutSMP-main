...
public final class VisibilityKey {
    private final UUID viewerId;
    private final UUID targetId;

    public VisibilityKey(UUID viewerId, UUID targetId) {
    ...
    @Override public String toString() {
        return "VisibilityKey[viewerId=+viewerId, targetId=+targetId]";
    }
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (o == null || getClass() != o.getClass()) return false;
        VisibilityKey that = (VisibilityKey) o;
        return java.util.Objects.equals(viewerId, that.viewerId) && java.util.Objects.equals(targetId, that.targetId);
    }
    @Override public int hashCode() {
        return java.util.Objects.hash(viewerId, targetId);
    }
}
}
