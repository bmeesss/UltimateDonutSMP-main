...
public final class SelectedKeyReward {
    private final String crateId;
    private final int amount;
    private final int weight;
    private final String displayName;

    public SelectedKeyReward(String crateId, int amount, int weight, String displayName) {
    ...
    @Override public String toString() {
        return "SelectedKeyReward[crateId=+crateId, amount=+amount, weight=+weight, displayName=+displayName]";
    }
    @Override public boolean equals(Object o) {
        if (this == o) return true;
        if (o == null || getClass() != o.getClass()) return false;
        SelectedKeyReward that = (SelectedKeyReward) o;
        return java.util.Objects.equals(crateId, that.crateId) && java.util.Objects.equals(amount, that.amount) && java.util.Objects.equals(weight, that.weight) && java.util.Objects.equals(displayName, that.displayName);
    }
    @Override public int hashCode() {
        return java.util.Objects.hash(crateId, amount, weight, displayName);
    }
}
}
